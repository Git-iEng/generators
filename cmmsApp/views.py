...
def request_demo_view(request):
    ...
    subject = "New Generators inquiry"
    text_body = (
        "A new Generators inquiry request was submitted.\n\n"
        f"Submitted: {ts}\n"
    ...
    html_body = f"""
        <h2 style="margin:0 0 8px">New Generators Inquiry Request</h2>
...
def contact_section(request):
    ...
    if request.method == "POST" and form.is_valid():
        ...
        # Email body
        subject = "New website contact submission for Generators Inquiry"
        text_body = "\n".join(
            [
                "New contact submission for Generators Inquiry:",
